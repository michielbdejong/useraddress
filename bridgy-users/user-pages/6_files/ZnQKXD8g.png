...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  ...
  <body>
        ...
        <div class="global-nav-inner">
          <div class="container">
            <ul class="nav js-global-actions">
              <li class="home">
                <a class="nav-logo-link" href="https://twitter.com"><img class="bird" src="https://abs.twimg.com/errors/logo23x19.png" alt="Twitter"></a>
              </li>
            </ul>
    ...
    <div class="blue-sky">
      <div class="body-content">
        ...
        <div class="footer">
          ...
          <ul class="links">
            <li class="first">&copy; <span id="copyright-year"></span> Twitter</li>
    ...
    <script src="https://abs.twimg.com/errors/404-4f54405af9c0bcdecbe656ca8893f7a9.js"></script>
  </body>
</html>
